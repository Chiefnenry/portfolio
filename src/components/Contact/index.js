          ...
          <div data-aos={"slide-up"} className="text-center mt-10">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://instagram.com/chief_nenry?igshid=OGQ5ZDc2ODk2ZA==",
                    "_blank"
                  )
                }
              >
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/charles-omosegbon-12a4a7308",
                    "_blank"
                  )
                }
              >
            ...
            <div className="mt-6 italic text-sm font-medium text-blue-500 ">
              ...
              <span>2023 Charles I Omosegbon</span>
            </div>
          </div>
        </div>
        <ToastContainer
